class StringParams {
  ...
  static final Map<String, String> en = {
    ...
    /// MapStartPage
    ///
    "MapStartPage.title": "Pick your origin",
    "MapStartPage.message": "Move the map and drop the pin "
        "at the location where you want to start your route.",
    "MapStartPage.set": "Set",
    "MapStartPage.cancel": "Cancel",

    ///
    /// MapStopPage
    ///
    "MapStopPage.title": "Pick your destination",
    "MapStopPage.message":
